...
* [1.5 find_$lt_$lte](#15-find_lt_lte)
* [1.6 find_$gte_$gt](#16-find_gte_gt)
* [1.7 find_$gt_$lt](#17-find_gt_lt)
* [1.8 錯誤示範: 不會有錯誤訊息](#18-錯誤示範-不會有錯誤訊息)
* [1.9 Find elements in an array](#19-find-elements-in-an-array)
* [1.10 完全查詢](#110-完全查詢)
* [1.11 指定型態 $type](#111-指定型態-type)
